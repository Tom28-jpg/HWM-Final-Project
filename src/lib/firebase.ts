...
// Use initializeFirestore with experimentalForceLongPolling and persistent offline cache
// This prevents [code=unavailable] WebChannel/gRPC connection drops in containerized & sandboxed browsers
